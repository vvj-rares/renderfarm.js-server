        ...
        express.get('/project', async function (req, res) {
            ...
            this._database.getProjects(apiKey)
                ...
                .catch(function(err){
                    ...
                    res.status(500);
                    res.end(JSON.stringify({ error: "failed to retrieve projects" }, null, 2));
                });
        }.bind(this));
        ...
        express.get('/project/:uid', async function (req, res) {
            ...
            this._database.getProject(apiKey, req.params.uid)
                ...
                .catch(function(err) {
                    ...
                    res.status(500);
                    res.end(JSON.stringify({ error: "failed to get project" }, null, 2));
                }.bind(this));
        }.bind(this));
            ...
            this._database.createProject(apiKey, name)
                .then(function(project) {
                    ...
                    sftp.connect({
                        ...
                        sftp.mkdir(projectPath, true)
                            .then(function(mkdirResult) {
                                ...
                                this._database.updateProject(apiKey, project)
                                    ...
                                    .catch(err => {
                                        ...
                                        res.status(500);
                                        res.end(JSON.stringify({ error: "failed to update project directory in database" }, null, 2));
                                    })
                            ...
                            .catch (err => {
                                ...
                                res.status(500);
                                res.end(JSON.stringify({ error: "failed to create project directory" }, null, 2));
                            });
                    ...
                    .catch((err) => {
                        ...
                        res.status(500);
                        res.end(JSON.stringify({ error: "failed to access project storage" }, null, 2));
                    });
                ...
                .catch(function(err) {
                    ...
                    res.status(500);
                    res.end(JSON.stringify({ error: "failed to create project" }, null, 2));
                }.bind(this));
        }.bind(this));
        ...
        express.put('/project/:uid', async function (req, res) {
            ...
            this._database.getProject(apiKey, req.params.uid)
                .then(function(project) {
                    ...
                    this._database.updateProject(apiKey, project)
                        ...
                        .catch(function(err) {
                            ...
                            res.status(500);
                            res.end(JSON.stringify({ error: "failed to update project" }, null, 2));
                        });
                ...
                .catch(function(err) {
                    ...
                    res.status(500);
                    res.end(JSON.stringify({ error: "failed to get project from database" }, null, 2));
                }.bind(this));
        }.bind(this));
        ...
        express.delete('/project/:uid', async function (req, res) {
            ...
            this._database.deleteProject(apiKey, projectGuid)
                .then(function() {
                    ...
                    sftp.connect({
                        ...
                        sftp.rmdir(projectPath, true)
                            .then(function(mkdirResult) {
                                console.log(`    OK | ${mkdirResult}`);
                                res.end(JSON.stringify({ deleted: projectGuid }, null, 2));
                            }.bind(this))
                            .catch (err => {
                                console.error(`  FAIL | failed to delete project directory\n`, err);
                                res.status(500);
                                res.end(JSON.stringify({ error: "failed to delete project directory" }, null, 2));
                            });
                ...
                .catch(function(err) {
                    ...
                    res.status(500);
                    res.end(JSON.stringify({ error: "failed to delete project from database" }, null, 2));
                }.bind(this));
        }.bind(this));
